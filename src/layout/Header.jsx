    ...
    <header className="w-full bg-white shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center py-4 gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:gap-6 gap-3 w-full sm:w-auto text-center sm:text-left">
          ...
          {/* Email */}
          <a
            href="mailto:info@b4blurb.com"
            className="flex justify-center sm:justify-start items-center gap-2 text-base sm:text-lg hover:text-emerald-600 transition"
          >
            {/* email icon */}
            <svg
              stroke="currentColor"
          ...
          {/* CTA Button */}
          <a href="tel:+12082914545">
            <button
              aria-label="Start live chat"
              className="bg-emerald-500 cursor-pointer rounded-2xl py-2 px-5 sm:py-2.5 sm:px-6 font-bold text-white text-sm sm:text-base lg:text-lg hover:bg-emerald-600 transition"
            >
              Live Chat
            </button>
          </a>
